 ...
 *
 * 85vw read as "this card is the whole screen" rather than "this scrolls": on
 * a 440px phone it left only a 34px sliver of the next card showing, and with
 * the cards themselves shortened since (see VisaCard, PackageCard, CruiseCard)
 * a card that wide over content that short looked stretched rather than
 * compact. 72vw leaves roughly 100px of the next card in view — enough to
 * read as "there's more here", not enough to spoil it.
 *
 ...
 */
export const railCardClass = "w-[72vw] shrink-0 snap-start sm:w-72 lg:w-80";
