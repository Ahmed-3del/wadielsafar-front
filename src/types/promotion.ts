...
export interface Promotion {
  ...
  ends_at: string | null;
  icon: PromotionIcon;
  /** Where "claim" leads, as a site-relative path. Empty sends the reader to
   *  the contact form carrying the code. */
  link: string;
  /** Overrides the button's wording. Empty uses the site's own. */
  cta_label_ar: string;
  cta_label_en: string;
  order: number;
}
